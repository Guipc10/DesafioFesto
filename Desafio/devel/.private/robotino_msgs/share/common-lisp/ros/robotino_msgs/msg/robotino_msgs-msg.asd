...
(defsystem "robotino_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "DistrCenter" :depends-on ("_package_DistrCenter"))
    (:file "_package_DistrCenter" :depends-on ("_package"))
    ...
    (:file "Machine" :depends-on ("_package_Machine"))
    (:file "_package_Machine" :depends-on ("_package"))
    ...
    (:file "PuckInfo" :depends-on ("_package_PuckInfo"))
    (:file "_package_PuckInfo" :depends-on ("_package"))
    ...
    (:file "StateId" :depends-on ("_package_StateId"))
    (:file "_package_StateId" :depends-on ("_package"))
