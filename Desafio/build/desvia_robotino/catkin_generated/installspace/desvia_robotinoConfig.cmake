...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'desvia_robotino' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/guiloko/Desafio/install/${idir}'.  Ask the maintainer 'guiloko <guiloko@todo.todo>' to fix it.")
    endif()
